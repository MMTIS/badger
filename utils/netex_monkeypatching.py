...
setattr(ServiceJourneyRef, "ref_version_hash", ref_version_hash)
setattr(ServiceJourneyPatternRef, "ref_version_hash", ref_version_hash)
setattr(OperatorRef, "ref_version_hash", ref_version_hash)
setattr(DayTypeRef, "ref_version_hash", ref_version_hash)
setattr(OperatingPeriodRef, "ref_version_hash", ref_version_hash)
setattr(UicOperatingPeriodRef, "ref_version_hash", ref_version_hash)
setattr(LineRef, "ref_version_hash", ref_version_hash)
setattr(QuayRef, "ref_version_hash", ref_version_hash)
setattr(ScheduledStopPointRef, "ref_version_hash", ref_version_hash)
...
setattr(ValidityConditionsRelStructure, "vc_refs_hash", ref_version_hash)
...
setattr(ServiceJourney, "id_version_hash", ref_version_hash)
setattr(ServiceJourneyPattern, "id_version_hash", ref_version_hash)
...
setattr(Locale, "hash_locale", ref_version_hash)
setattr(LocaleStructure, "hash_locale", ref_version_hash)
